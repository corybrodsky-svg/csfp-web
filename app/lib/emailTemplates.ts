...
const FRIENDLY_MERGE_PLACEHOLDERS: Record<string, string> = {
  ...
  eventZoomLink: "Event access TBD",
  spFirstName: "SP",
...
const MERGE_FIELD_ALIASES: Record<string, string> = {
  ...
  eventzoomlink: "eventZoomLink",
  eventlink: "eventZoomLink",
  eventurl: "eventZoomLink",
